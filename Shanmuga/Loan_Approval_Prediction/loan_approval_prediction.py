...
Objective:
Predict whether a loan should be approved using Decision Trees & Ensemble methods 
(Random Forest, XGBoost, LightGBM, CatBoost).

Dataset:
The dataset contains information about loan applicants, including gender, marital status, 
